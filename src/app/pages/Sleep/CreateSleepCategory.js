...
export function CreateSleepCategory({ show, onClose, setSubs }) {
    ...
    const onAlbumCreate = () => {
        ...
        if (subName !== null && subName !== undefined && subName !== "") {
            ...
            var ref = storage.ref(`sleep/${id}/fakeBlob`).put(blob);
                ...
                () => {
                    storage.ref(`sleep/${id}`)
                        ...
                        .then(url => {
                            ...
                            firestore.collection("sleepCategories").add({
                                id: id,
                                name: subName
                            }).then(res => {
